...
Konventionen:
- TEXT für Zeitstempel im ISO-8601-Format
- INTEGER für Booleans (0/1)
- Fremdschlüssel mit explizitem ON DELETE-Verhalten

Inhalt der Datenbank (alles lokal, verlässt den Projektordner nie):
- settings          zentrale, im UI änderbare Betriebseinstellungen
- woerter           persönliches Wörterbuch (Lernen Stufe 1)
- ngramme           N-Gramm-Häufigkeiten (Lernen Stufe 1)
- kontext_passagen  eingebettete Passagen für den Umfeld-Kontext (Lernen Stufe 2)
- profile           benutzerdefinierte Schreibprofile (ergänzen die eingebauten)
...
CREATE TABLE IF NOT EXISTS ngramme (
    ...
    praefix TEXT NOT NULL,                     -- n-1 vorangehende Wörter, klein, leer-getrennt
...
CREATE TABLE IF NOT EXISTS profile (
    ...
    stil_prompt TEXT NOT NULL DEFAULT '',      -- System-Hinweis für die LLM-Ergänzung
...
# Migrationen für bereits existierende Datenbanken.
