...
from app.routers import complete, correct, learn, profile, satz, spellcheck, system, woerterbuch
...
def create_app() -> FastAPI:
    ...
    app.include_router(satz.router, prefix="/api")
    app.include_router(complete.router, prefix="/api")
